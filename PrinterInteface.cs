...
namespace BackgroundSocketAndPrinterApp
{
    class PrinterInteface
    {
        ...
        public PrinterInteface(string upc)
        {
            if (upc == null)
            {
        ...
        public String printBarCode(JsonValue json)
        {
            //     SendStringToPrinter(printers[0], "hello");
        ...
        public String printReceipt(JsonValue json)
        {
            return "";
        }
    ...
    public class RawPrinterHelper
    {
        ...
        public static bool SendBytesToPrinter(string szPrinterName, IntPtr pBytes, Int32 dwCount)
        {
            ...
            {
                // Start a document.
                if (StartDocPrinter(hPrinter, 3, di))
                {
                    // Start a page.
